...
export const Footer: React.FC<FooterProps> = ({ lang, onOpenStaffQr }) => {
  return (
    <footer className="bg-white border-t border-slate-200 mt-12 py-10 px-4 sm:px-6 font-jakarta text-slate-700 no-print">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-xs">
          ...
          <div className="space-y-2">
            <h4 className="font-extrabold text-sm text-slate-900 flex items-center gap-1.5">
              ...
              <span>Adresă Hotel & Restaurant</span>
            </h4>
          ...
          <div className="space-y-2">
            <h4 className="font-extrabold text-sm text-slate-900 flex items-center gap-1.5">
              ...
              <span>Contact & Recepție</span>
            </h4>
            <p className="text-slate-600 font-inter space-y-1">
              <div>Recepție: <a href={`tel:${HOTEL_INFO.phoneReceptie}`} className="font-bold text-[#C19B77] hover:underline">{HOTEL_INFO.phoneReceptie}</a></div>
          ...
          <div className="space-y-2">
            <h4 className="font-extrabold text-sm text-slate-900 flex items-center gap-1.5">
              ...
              <span>Guest Wi-Fi Terasă</span>
            </h4>
            <div className="bg-[#F8F6F2] p-3 rounded-2xl border border-slate-200 space-y-1">
              <div className="text-slate-500 text-[11px]">Rețea: <span className="font-bold text-slate-900">{HOTEL_INFO.wifiSsid}</span></div>
          ...
          <div className="space-y-2">
            <h4 className="font-extrabold text-sm text-slate-900 flex items-center gap-1.5">
              ...
              <span>Protecția Consumatorului</span>
            </h4>
        ...
        <div className="pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-400">
          <div>
            © {new Date().getFullYear()} {HOTEL_INFO.name}. Compliant with ANPC Order 201/2022 & OUG 28/1999.
          </div>
