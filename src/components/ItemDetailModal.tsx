...
export const ItemDetailModal: React.FC<ItemDetailModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 liquid-overlay font-jakarta no-print">
        <motion.div
        ...
        >
          ...
          <div className="relative h-56 sm:h-64 w-full bg-slate-100 shrink-0 overflow-hidden">
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 bg-black/50 hover:bg-black/80 text-white p-2 rounded-full backdrop-blur-xl border border-white/20 transition-all shadow-lg cursor-pointer z-20 hover:scale-105 active:scale-95"
              title={t.closeBtn}
            >
              <X className="w-5 h-5" />
            </button>
