    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-xs no-print">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-3">
        ...
        >
          ...
          <div className="h-12 sm:h-14 md:h-16 flex items-center justify-center transition-transform group-hover:scale-105">
            <img
              src={HOTEL_INFO.logoUrl}
              alt="Hotel Marissa Logo"
              className="h-12 sm:h-14 md:h-16 w-auto max-w-[180px] sm:max-w-[220px] object-contain"
              onError={(e) => {
          ...
          <div className="hidden xs:block border-l border-slate-200 pl-3 py-0.5">
            <h1 className="font-jakarta font-extrabold text-base sm:text-lg text-slate-900 group-hover:text-[#C19B77] transition-colors tracking-tight">
              RESTAURANT MARISSA
            </h1>
            <p className="text-[10px] sm:text-[11px] text-slate-500 font-bold tracking-widest uppercase font-jakarta">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 sm:py-1.5 rounded-full bg-[#F8F6F2] hover:bg-amber-100/60 border border-[#C19B77]/40 text-slate-900 text-xs font-jakarta font-bold transition-all shadow-2xs hover:border-[#C19B77] cursor-pointer"
