...
def parse_header_perfect(line):
    ...
    # Search for numbers and unit at end of prefix e.g. "3,7300gr.", "3,7 250gr", "3,7225 gr.", "7100 gr.", "7200 ml.", "725 gr."
    ...
    if u_match:
        ...
        # Check for slashes in num_part (e.g. 25/80/100/25 or 200/50)
        if '/' in num_part:
            ...
            # Simple number string e.g. "3,7300", "3,7 250", "3,7225", "3300", "1,3, 7, 11 370", "7100", "7200", "725"
            # If comma or space separates allergens from weight e.g. "3,7 250" or "1,3, 7, 11 370"
            ...
            if m_sep:
                ...
                # Digits without explicit separator e.g. "3,7300" or "3,7225" or "7100" or "7200" or "725" or "3300" or "100"
    ...
    # Clean name trailing commas/dots
    name = re.sub(r'[,.\s]+$', '', name).strip()
    
    # Check if name has trailing allergen numbers e.g. "Cremvurşti 7"
...
print("=== PERFECT WEIGHT PARSER TEST ===")
for i, l in enumerate(lines[:30]):
    if re.search(r'(\d+([.,]\d+)?)\s*(lei|LEI|ron|RON)', l):
        parsed = parse_header_perfect(l)
        if parsed:
            n, w, p, a = parsed
